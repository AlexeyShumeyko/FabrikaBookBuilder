    ...
    public class Book : ViewModelBase
    {
        ...
        private void Page_PropertyChanged(object? sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == nameof(Page.SourcePath) || e.PropertyName == nameof(Page.ThumbnailPath) || e.PropertyName == nameof(Page.IsEmpty))
            {
                ...
                // КРИТИЧЕСКИ ВАЖНО: Обновляем AllSlotsPages для обновления UI
                OnPropertyChanged(nameof(AllSlotsPages));
                
                // КРИТИЧЕСКИ ВАЖНО: Обновляем IsValid при изменении SourcePath
                UpdateIsValid();
            }
        }
        ...
        private void Pages_CollectionChanged(object? sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            // КРИТИЧЕСКИ ВАЖНО: Обновляем IsValid при изменении коллекции страниц
            UpdateIsValid();
        }
        ...
        public void UpdatePageSlots()
        {
            ...
            // КРИТИЧЕСКИ ВАЖНО: Обновляем коллекцию Page объектов для прямого биндинга
        ...
        // КРИТИЧЕСКИ ВАЖНО: Коллекция Page объектов для прямого биндинга (вместо MultiBinding)
